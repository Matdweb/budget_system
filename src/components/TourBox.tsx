...
function TourBox() {
    ...
    return (
        <div
            className='w-72 h-28 mt-12 flex justify-between items-center flex-row rounded-lg active:scale-95 transition-all duration-75 cursor-pointer'
        ...
        >
            ...
            <div
                className='w-16 hover:w-12 h-full rounded-r-lg transition-all duration-700 ease-out'
